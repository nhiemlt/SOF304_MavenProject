...
public class KhachHang extends javax.swing.JPanel {
	...
	public String Them_test(model.KhachHang kh) {

		if (kiemLoi_test(kh).isEmpty()) {
		...
		return kiemLoi_test(kh);
	}

	public String taoMaKH_test(List<model.KhachHang> list) {

		if (list == null || list.isEmpty()) {
			return "KH001";
		}
		model.KhachHang kh = list.get(list.size() - 1);
	...
	public String CapNhat_Test(model.KhachHang kh) {
		...
		return CapNhat_Test(kh);
	}

	public String Xoa_Test(String maKH) {
		if (!Auth.isManager()) {
			return "Bạn không có quyền xóa khách hàng";
		} else if (maKH == null || maKH.isEmpty()) {
			return "Mã khách hàng rỗng";
		}
		model.KhachHang kh = khDAO.selectByID(maKH);
		if (kh == null) {
	...
	void Xoa() {
		if (!Auth.isManager()) {
			...
			int option = JOptionPane.showConfirmDialog(null, "Bạn muốn xoá khách hàng này chứ?", "Xác nhận",
...
//        this.updateStatus();
	...
	void fillTableHoaDon() {
		...
		try {
			...
			for (model.HoaDon hd : list) {
				...
				Object[] rows = { hd.getMaHD(), tenNV, XDate.toString(hd.getNgayBan(), "dd-MM-yyyy"),
						format.format(hd.getTongTien()) };
				model.addRow(rows);
			}
		} catch (Exception e) {
	...
	public boolean KiemLoi() {
		...
		if (txtSoDienThoai.getText().isEmpty()
				|| !txtSoDienThoai.getText().matches("(84|0[3|5|7|8|9])+([0-9]{8})\\b")) {
	...
	public String kiemLoi_test(model.KhachHang kh) {
		try {
			if (kh.getTenKH().isEmpty()) {
				return "Tên khách hàng không được để trống";
			}
			if (!kh.getTenKH().matches("[^0-9]+")) {
				return "Tên khách hàng không được chứa kí tự số";
			}
			if (kh.getTenKH().length() > 255) {
				return "Tên khách hàng không được vượt quá 255 kí tự";
			}

			if (!kh.getTenKH().matches("^[^!-@]+$")) {
				return "Tên khách hàng không chứa kí tự đặt biệt";
			}
			if (kh.getSDT().isEmpty()) {
				return "Số điện thoại không được để trống";
			}
			if (!kh.getSDT().matches("(84|0[3|5|7|8|9])+([0-9]{8})\\b")) {
	...
	private void initComponents() {
		...
		}, new String[] { "Mã hóa đơn", "Tên nhân viên", "Ngày bán", "Tổng tiền" }));
		...
		}, new String[] { "STT", "ID", "Tên khách hàng", "Số điện thoại", "Địa chỉ" }) {
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addGap(19, 19, 19)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 1242,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 321,
										javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(jPanel1,
						javax.swing.GroupLayout.PREFERRED_SIZE, 1436, javax.swing.GroupLayout.PREFERRED_SIZE)));
