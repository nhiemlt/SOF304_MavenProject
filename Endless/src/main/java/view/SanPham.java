...
public class SanPham extends javax.swing.JPanel {
		...
		try {
			...
			for (model.SanPham sp : list) {
				Object[] rows = { sp.getMaSP(), sp.getTenSP(), lgDAO.selectById(sp.getMaLoaiGiay()).getTenLoaiGiay(),
						xn.formatDecimal(sp.getDonGiaNhap()), xn.formatDecimal(sp.getDonGiaBan()),
						xn.formatDecimal(sp.getGiaKhuyenMai()), sp.getMaVach(), sp.getHinhAnh() };
				model.addRow(rows);
			}
		} catch (Exception e) {
	...
	void fillTableChiTietSanPham(String id) {
		...
		try {
			...
			for (model.ChiTietSanPham ctsp : list) {
				Object[] rows1 = { ctsp.getMaCTSP(), msDAO.selectByID(ctsp.getMaMau()).getTenMauSac(),
						ktDAO.selectByID(ctsp.getMaKT()).getTenKichThuoc(), ctsp.getSoLuong(), ctsp.getMoTa() };
				model.addRow(rows1);
			}
		} catch (Exception e) {
			System.out.println(e);
	...
	// Hàm để kiểm thử chức năng tạo mã sản phẩm
	public String taoMaSP_Test(List<model.SanPham> list) {
	...
	void XoaCTSP() {
		if (!Auth.isManager()) {
			...
			int yesNo = JOptionPane.showConfirmDialog(this,
					"Bạn thực sự muốn xóa thuộc tính chi tiết sản phẩm này?");
			if (yesNo == JOptionPane.YES_NO_OPTION) {
				try {
					ctspDAO.delete(id);
	...
	private void initComponents() {
		...
		}, new String[] { "Mã sản phẩm", "Tên sản phẩm", "Loại giày", "Giá nhập", "Giá bán",
				"Giá khuyến mãi", "Mã vạch", "Hình ảnh" }) {
				...
				.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
										.addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, 1280,
		...
		jPanel1Layout
				.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
										.addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, 699,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(0, 0, Short.MAX_VALUE))));
		...
		cboKichThuoc.setModel(
				new javax.swing.DefaultComboBoxModel<>(new String[] { "37", "38", "39", "40", "41", "42", "43", " " }));
		...
		tblThuocTinh.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "Mã chi tiết sản phẩm", "Màu sắc", "Kích thước ", "Số lượng", "Mô tả" }) {
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
						.addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 701,
								javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(tpnTab));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addComponent(tpnTab).addContainerGap()));
