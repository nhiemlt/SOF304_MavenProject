...
public class KhuyenMai extends javax.swing.JPanel {
	...
	public void timKiem() {
		...
		try {
			...
			for (model.SanPham SP : list) {
				Object[] rows = { false, SP.getMaSP(), SP.getTenSP(),
						lgDAO.selectById(SP.getMaLoaiGiay()).getTenLoaiGiay(), format.format(SP.getDonGiaNhap()),
						format.format(SP.getDonGiaBan()) };
				model.addRow(rows);
			}
		} catch (Exception e) {
	...
	public void fillTableSanPham(String tenLoaiGiay) {
		...
		try {
			...
			for (model.SanPham SP : list) {
				...
				Object[] rows = { km, SP.getMaSP(), SP.getTenSP(),
						lgDAO.selectById(SP.getMaLoaiGiay()).getTenLoaiGiay(), format.format(SP.getDonGiaNhap()),
						format.format(SP.getDonGiaBan()) };
				model.addRow(rows);
			}
	...
	public void fillTableKhuyenMai() {
		...
		try {
			...
			for (model.KhuyenMai km : list) {
				...
				Object[] rows = { i, km.getMaKM(), km.getTenKM(), mgg, XDate.toString(km.getNgayBatDau(), "dd-MM-yyyy"),
	...
	public String taoMaKM_Test(List<model.KhuyenMai> list) {

		if (list == null || list.isEmpty()) {
			return "KM001";
		}
		model.KhuyenMai km = list.get(list.size() - 1);

		String oldID = km.getMaKM();
	...
	public String capnhat_Test(model.KhuyenMai km, List<SanPham> list) {
		if (KiemLoi_Test(km).isEmpty()) {

			km.setMaKM(taoMaKM());
			try {
				kmDAO.update(km);
				if (list == null) {
					return "Cập nhật thành công với 0 sản phẩm";
				} else {
					for (SanPham sp : list) {
						sp.setMaKM(km.getMaKM());
						double giaBan = sp.getDonGiaBan();
						int mucKM = (km.getMucGiamGia());
						double giaKM = (100 - mucKM) * 0.01 * giaBan;
						sp.setGiaKhuyenMai(giaKM);
						try {
							spDAO.update(sp);
				...
				return "Cập nhật thành công với " + list.size() + " sản phẩm";
			} catch (Exception e) {
				return e + "";
			}
		}
		return KiemLoi_Test(km);
	}
...
//        this.updateStatus();
	...
	public String them_Test(model.KhuyenMai km, List<SanPham> list) {
		if (KiemLoi_Test(km).isEmpty()) {
			...
			try {
				kmDAO.insert(km);
				if (list == null) {
					return "Thêm thành công với 0 sản phẩm";
				} else {
					for (SanPham sp : list) {
						sp.setMaKM(km.getMaKM());
						double giaBan = sp.getDonGiaBan();
				...
				return "Thêm thành công với " + list.size() + " sản phẩm";
			} catch (Exception e) {
				return e + "";
			}
		}
	...
	public String KiemLoi_Test(model.KhuyenMai km) {
		...
		if (km.getMucGiamGia() == 0) {
			...
			String mucggStr = Integer.toString(km.getMucGiamGia());
			try {
				int mucgg = Integer.parseInt(mucggStr);
				if (mucgg <= 0) {
					return "Mức giảm giá phải lớn hơn 0";
				} else if (mucgg > 90) {
					return "Mức giảm giá không được lớn hơn 90";
				}
			} catch (NumberFormatException e) {
				return "Mức giảm giá sai định dạng";
			}
		}

		Date ngayBatDauStr = km.getNgayBatDau();

		if (ngayBatDauStr == null) {
			return "Ngày bắt đầu không được để trống";
		} else {
			Date ngayKetThucStr = km.getNgayKetThuc();
			if (ngayKetThucStr == null) {
				return "Ngày kết thúc không được để trống";
			} else if (ngayKetThucStr.before(ngayBatDauStr)) {
	...
	private void initComponents() {
		...
		tblDanhSachSanPham.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "", "ID", "Tên sản phẩm", "Loại giày", "Giá nhập", "Giá bán" }) {
		...
		cboHinhThucGiamGia
				.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả sản phẩm", "Tùy chọn" }));
		cboHinhThucGiamGia.setSelectedIndex(1);
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 312,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
										jPanel2Layout.createSequentialGroup().addGap(8, 8, 8).addComponent(jLabel1)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(cboApDung, javax.swing.GroupLayout.PREFERRED_SIZE, 185,
														javax.swing.GroupLayout.PREFERRED_SIZE)))
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
						...
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								...
								.addGroup(jPanel2Layout.createSequentialGroup().addComponent(jLabel2)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(cboHinhThucGiamGia, javax.swing.GroupLayout.PREFERRED_SIZE, 173,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addGap(6, 6, 6)));
		jPanel2Layout
				.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
								...
								.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										...
										.addComponent(cboHinhThucGiamGia, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(cboApDung, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
												javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(40, 40, 40).addGroup(jPanel1Layout
						...
						.addComponent(jLabel6).addComponent(jLabel5).addComponent(jLabel4).addComponent(jLabel8)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
								.addComponent(btnThem, javax.swing.GroupLayout.PREFERRED_SIZE, 114,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(btnCapNhat, javax.swing.GroupLayout.PREFERRED_SIZE, 108,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(btnXoa, javax.swing.GroupLayout.PREFERRED_SIZE, 93,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(btnLamMoi, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addComponent(dcsNgayBatDau, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(dcsNgayKetThuc, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(txtMucGiamGia).addComponent(txtTenKhuyenMai).addComponent(txtMaKhuyenMai))
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(50, 50, 50).addComponent(jLabel3)
						.addGap(52, 52, 52).addComponent(jLabel4).addGap(18, 18, 18)
						.addComponent(txtMaKhuyenMai, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jLabel5)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(txtTenKhuyenMai, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(12, 12, 12).addComponent(jLabel6)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(txtMucGiamGia, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(17, 17, 17).addComponent(jLabel7)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(dcsNgayBatDau, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jLabel8)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(dcsNgayKetThuc, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
								javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sách khuyến mãi",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Segoe UI", 1, 14))); // NOI18N

		tblDanhSachKhuyenMai.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
		tblDanhSachKhuyenMai.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "STT", "Mã khuyến mãi", "Tên khuyến mãi", "Mức giảm giá", "Ngày bắt đầu", "Ngày kết thúc" }) {
