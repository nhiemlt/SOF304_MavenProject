...
public class login extends javax.swing.JFrame {
	...
	// Kiểm tra hàm đăng nhập
	public String dangNhap_Test(String username, String password) {
		try {
			model.NhanVien nv = dao.selectByUserName(username);
			if (batLoi_Test(username, password).equals("")) {
				if (!en.checkPassword(String.valueOf(password), nv.getMatKhau())) {
					return "Lỗi sai mật khẩu";
				} else {
					Auth.user = nv;
					Auth.user.setMaTK(username);
				}
			}
			else {
				return batLoi_Test(username, password);
			}
			return "pass";
		} catch (Exception e) {
			return "fail";
	...
	// Kiểm tra hàm bắt lỗi login
	public String batLoi_Test(String username, String password) {
		model.NhanVien nv = dao.selectByUserName(username);
		Auth.user = nv;
		
		String err = "";
		if (username.isEmpty()) {
			err += "Lỗi để trống tên đăng nhập\n";
		}
		if (password.isEmpty()) {
			err += "Lỗi để trống mật khẩu\n";
		}
		if (nv == null) {
			err += "Lỗi tên đăng nhập không tồn tại";
		}
		return err;
	}
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addComponent(pnlDangNhap, javax.swing.GroupLayout.PREFERRED_SIZE, 1280,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				pnlDangNhap, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 736,
				Short.MAX_VALUE));
