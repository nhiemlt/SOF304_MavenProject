...
public class ThuocTinh extends javax.swing.JPanel {
	...
	// TEST
	public String taoMaMS_Test(List<MauSac> list) {
		if (list == null || list.size() == 0) {
			return "MS001";
		}
		MauSac ms = list.get(list.size() - 1);
	...
	// TEST
	public String taoMaKT_Test(List<KichThuoc> list) {
		if (list == null || list.size() == 0) {
			return "KT001";
		}
		KichThuoc kt = list.get(list.size() - 1);
		String oldID = kt.getMaKichThuoc();
		String number = oldID.substring(2, oldID.length());
		String newID = "KT";
		int idNumber = Integer.parseInt(number) + 1;
	...
	// TEST
	public String ThemMauSac_Test(MauSac ms) {
		if (KiemLoiMau_Test(ms).isEmpty()) {
			ms.setMaMauSac(taoMaMS());
			try {
				msDAO.insert(ms);
				return "Thêm màu sắc thành công!";
			} catch (Exception e) {
				return "Thêm màu sắc thất bại!";
			}
		} else {
			return KiemLoiMau_Test(ms);
		}
	...
	// TEST
	public String ThemKichThuoc_Test(KichThuoc kt) {
		if (KiemLoiKichThuoc_Test(kt).isEmpty()) {
			kt.setMaKichThuoc(taoMaKT());
			try {
				ktDAO.insert(kt);
				return "Thêm kích thước thành công!";
			} catch (Exception e) {
				return "Thêm kích thước thất bại!";
			}
		} else {
			return KiemLoiKichThuoc_Test(kt);
		}
	}
	...
	// TEST
	public String CapNhatMauSac_Test(MauSac ms) {
		MauSac check = msDAO.selectByID(ms.getMaMauSac());
		if (KiemLoiMau_Test(ms).isEmpty()) {
			try {
				if (check == null) {
					return "Mã màu không tồn tại";
				}
				msDAO.update(ms);
	...
	// TEST
	public String CapNhatKichThuo_Test(KichThuoc kt) {
		KichThuoc check = ktDAO.selectByID(kt.getMaKichThuoc());
		if (KiemLoiKichThuoc_Test(kt).isEmpty()) {
			try {
				if (check == null) {
					return "Mã kích thước không tồn tại";
				}
				ktDAO.update(kt);
				return "Cập nhật kích thước thành công";
			} catch (Exception e) {
				return "Cập nhật kích thước thất bại!";
			}
		} else {
			return KiemLoiKichThuoc_Test(kt);
		}
	...
	//TEST
	public String XoaMauSac_Test(String maMauSac) {
		if (!Auth.isManager()) {
			return "Bạn không có quyền xóa thuộc tính màu sắc !";
		} else if (maMauSac == null || maMauSac.isEmpty()) {
			return "Lỗi mã màu rỗng";
		} else {
			MauSac ms = msDAO.selectByID(maMauSac);
			if (ms==null) {
				return "Mã màu không tồn tại";
			}
			try {
				msDAO.deleteByID(maMauSac);
				try {
					msDAO.insert(ms);
				} catch (Exception e) {
					e.printStackTrace();
	...
	//TEST
	public String XoaKichThuoc_Test(String maKichThuoc) {
		if (!Auth.isManager()) {
			return "Bạn không có quyền xóa thuộc tính kích thước !";
		} else if (maKichThuoc == null || maKichThuoc.isEmpty()) {
			return "Lỗi mã màu rỗng";
		} else {
			KichThuoc kt = ktDAO.selectByID(maKichThuoc);
			if (kt==null) {
				return "Mã kích thước không tồn tại";
			}
			try {
				msDAO.deleteByID(maKichThuoc);
				try {
					ktDAO.insert(kt);
				} catch (Exception e) {
					e.printStackTrace();
	...
	// TEST
	public String KiemLoiMau_Test(MauSac ms) {
		String err = "";
		ms.setMaMauSac(taoMaMS());
	...
	// TEST
	public String KiemLoiKichThuoc_Test(KichThuoc kt) {
		String err = "";
		kt.setMaKichThuoc(taoMaKT());
		if (kt.getTenKichThuoc().isEmpty()) {
			err += "Tên kích thước không được bỏ trống";
		}
	...
	private void initComponents() {
		...
		jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin màu sắc",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Segoe UI", 1, 14))); // NOI18N

		tblMauSac.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "Mã màu sắc", "Tên màu sắc", "Mô tả" }) {
		...
		jPanel6Layout.setVerticalGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel6Layout.createSequentialGroup().addComponent(jScrollPane5,
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(14, 14, 14)
								.addGroup(jPanel1Layout
										...
										.addGroup(jPanel1Layout.createSequentialGroup()
												.addComponent(btnThemMs1, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(28, 28, 28)
												.addComponent(btnCapNhatMs1, javax.swing.GroupLayout.PREFERRED_SIZE,
														120, javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(31, 31, 31)
												.addComponent(btnXoaMs1, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(btnLamMoiMs1, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addComponent(jLabel8).addComponent(jLabel9).addComponent(txtTenMau)
										.addComponent(txtMoTaMau, javax.swing.GroupLayout.DEFAULT_SIZE, 570,
												Short.MAX_VALUE))
								.addGap(0, 36, Short.MAX_VALUE)))
						.addContainerGap())
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel1Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(jLabel7,
								javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(242, 242, 242)));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(17, 17, 17).addComponent(jLabel7)
						.addGap(29, 29, 29).addComponent(jLabel8).addGap(12, 12, 12)
						.addComponent(txtTenMau, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(4, 4, 4)
						.addComponent(txtMoTaMau, javax.swing.GroupLayout.PREFERRED_SIZE, 67,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(btnThemMs1, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnCapNhatMs1, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnLamMoiMs1, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnXoaMs1, javax.swing.GroupLayout.PREFERRED_SIZE, 38,
										javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin kích thước",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Segoe UI", 1, 14))); // NOI18N

		tblKichThuoc.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "Mã kích thước", "Kích thước", "Mô tả" }) {
			boolean[] canEdit = new boolean[] { false, false, false };
				...
				.setHorizontalGroup(
						jPanel2Layout
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout
										.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(jLabel2,
								...
								.addGroup(jPanel2Layout
										.createSequentialGroup().addGroup(jPanel2Layout.createParallelGroup(
												javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(jPanel2Layout.createSequentialGroup().addGap(12, 12,
														12).addComponent(jPanel5,
																javax.swing.GroupLayout.PREFERRED_SIZE,
														...
														.addGroup(jPanel2Layout
																...
																.addGroup(jPanel2Layout.createSequentialGroup()
																		...
																		.addComponent(btnXoaKt,
																				...
																				120,
																				javax.swing.GroupLayout.PREFERRED_SIZE)
																		.addGap(30, 30, 30).addComponent(btnLamMoiKt,
																				javax.swing.GroupLayout.PREFERRED_SIZE,
																				120,
																				javax.swing.GroupLayout.PREFERRED_SIZE))
																.addComponent(jLabel5).addComponent(jLabel6)
																.addComponent(txtMoTaKt,
																		javax.swing.GroupLayout.DEFAULT_SIZE, 566,
																		Short.MAX_VALUE)
																.addComponent(txtKichThuoc))))
										.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addGap(23, 23, 23).addComponent(jLabel2)
						.addGap(28, 28, 28).addComponent(jLabel5).addGap(6, 6, 6)
						.addComponent(txtKichThuoc, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(24, 24, 24).addComponent(jLabel6)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(txtMoTaKt, javax.swing.GroupLayout.PREFERRED_SIZE, 69,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(btnThemKt, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnCapNhatKt, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnXoaKt, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnLamMoiKt, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
