...
public class addTest {
    ...
    public void TC_ADD_NV_01() {
        ...
        nv.setEmail("nguyenVanTeo@gmail.com");
        nv.setGioiTinh(true);
    ...
    public void TC_ADD_NV_02() {
        ...
        Assert.assertTrue(actualResult.contains("trống tên nhân viên"));
    }
    ...
    public void TC_ADD_NV_05() {
        ...
        String expectedResult = "fail";
        String actualResult = form.Add_Test(nv);
        Assert.assertEquals(actualResult, "Lỗi để trống SDT Lỗi sai định dạng SDT");
    }
